...
public class StandAloneTest {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		String email = "harshitsrivastava1991@gmail.com";
		String pass = "Oct@1810";
...
//		adding explicit wait on global level
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(5));

		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".mb-3")));
//		using java streams to first focus on 1 item and then click on add to cart for specific item-
...
//		code for disappering message of added to cart-
